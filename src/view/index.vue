      ...
      data: [
        {
          name: "系统管理",
          id: "0",
          child: [{ name: "用户管理", path: "/index/user.vue", id: "1" }]
        },
        {
          name: "客户管理",
          id: "2",
        ...
        },
        {
          ...
          id: "4",
          child: [
            { name: "任务管理", path: "/index/list.vue", id: "5" },
            { name: "任务广场", path: "/index/tasklist.vue", id: "6" }
          ]
        },
        {
          name: "终端管理",
          id: "7",
          child: [
            { name: "终端版本", path: "/index/version.vue", id: "8" },
            { name: "终端列表", path: "/index/terminallist.vue", id: "9" }
          ]
        },
        {
          name: "数据订单",
          id: "10",
          child: [
            { name: "所有订单", path: "/index/allorders.vue", id: "11" },
        ...
        },
        {
          ...
          id: "15",
          child: [
            { name: "所有订单", path: "/index/ikonorders.vue", id: "16" },
            { name: "未审批订单", path: "/index/ikonapproved.vue", id: "17" }
          ]
        },
        {
          name: "固定画像",
          id: "18",
          child: [
            { name: "所有固定画像", path: "/index/fixedikon.vue", id: "19" },
            { name: "未审批订单", path: "/index/fixedapproved.vue", id: "20" }
          ]
        },
        ...
        //   ]        },
        {
          ...
          child: [
            {
              name: "财务统计",
              path: "/index/financialstatistics.vue",
              id: "22"
            },
            { name: "清竹数据", path: "/index/bamboodata.vue", id: "23" },
            { name: "充提管理", path: "/index/rush.vue", id: "24" },
            { name: "客户财务", path: "/index/finance.vue", id: "25" }
          ]
        },
        {
          name: "场景配置",
          id: "26",
          child: [
            { name: "人群标签配置", path: "/index/crowdlabel.vue", id: "27" },
            { name: "区域数据配置", path: "/index/scenes.vue", id: "28" },
            { name: "行业数据配置", path: "/index/industrydata.vue", id: "29" },
            { name: "场景名称配置", path: "/index/scenesname.vue", id: "30" }
          ]
        }
  ...
  methods: {
    ...
    determine() {
      ...
      if (newcode != affirmcode) {
        ...
        this.$http
          .post(`sys/user/update_password`, info)
          .then(res => {
            this.$message({
              message: "修改成功，请重新登陆",
              type: "success"
    ...
    cancel() {
      (this.formcode = {}), (this.changecode = false);
    },
    // 消息中心
    bell() {
    ...
    dianji1(tab, event) {
      ...
      if (this.editableTabs[tab.name].name === "/index/ikonxq.vue") {
        this.$http
          .get(`modules/order/detail/${this.editableTabs[tab.name].id}`)
          .then(res => {
            var { code, data } = res.data;
            if (code === 1000) {
      ...
      console.log(id);
      this.$router.push({
        path: this.editableTabs[tab.name].name,
        query: { ids: id }
      });
    },
    reload() {
