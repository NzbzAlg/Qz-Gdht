  ...
  <div>
    ...
    >
      ...
      >
        ...
        <!-- 市级运营中心的下级 -->
        <el-row>
         <el-col :span="12" v-if="formkhfull.proxyType!=4&formkhfull.proxyType!=6&formkhfull.proxyType!=''&formkhfull.proxyType!=1&formkhfull.proxyType!=3&formkhfull.proxyType!=5&formkhfull.proxyType!=7&formkhfull.proxyType!=8&formkhfull.proxyType!=9">
        ...
        <!-- 市级一般代理的上级 -->
        <el-row>
          <el-col :span="12" v-if="formkhfull.proxyType!=4&formkhfull.proxyType!=6&formkhfull.proxyType!=''&formkhfull.proxyType!=1&formkhfull.proxyType!=2&formkhfull.proxyType!=5&formkhfull.proxyType!=7&formkhfull.proxyType!=8&formkhfull.proxyType!=9">
        ...
        <!-- 大客户的上级 -->
        <el-row>
          <el-col :span="12" v-if="formkhfull.proxyType!=6&formkhfull.proxyType!=1&formkhfull.proxyType!=''&formkhfull.proxyType!=2&formkhfull.proxyType!=3&formkhfull.proxyType!=5&formkhfull.proxyType!=7&formkhfull.proxyType!=8&formkhfull.proxyType!=9">
